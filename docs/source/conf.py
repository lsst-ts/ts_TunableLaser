...
release = get_distribution('ts-tunablelaser').version
...
autodoc_mock_imports=['salobj','SALPY_TunableLaser']
...
htmlhelp_basename = 'ts-tunablelaserdoc'
...
man_pages = [
    (master_doc, 'ts-tunablelaser', 'ts-tunablelaser Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ts-tunablelaser', 'ts-tunablelaser Documentation',
     author, 'ts-tunablelaser', 'One line description of project.',
     'Miscellaneous'),
]
